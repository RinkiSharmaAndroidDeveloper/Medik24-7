...
setContentView(R.layout.requestaccept);
        ...
        GlobalVariable.uidpat=data;
        SharedPreferences preferences=getApplicationContext().getSharedPreferences("PreferenceDisplay", 0);
        SharedPreferences.Editor editor=preferences.edit();
        editor.putString("DataGet",data);
        editor.commit();
        Log.e("DataID",data);
        apihit();
...
imageView.setOnClickListener(new View.OnClickListener() {
    ...
    public void apihit(){
      String datalink="http://vertosys.com/docpat/GetLocation.php?user_id=48";
        RequestQueue queue2 = Volley.newRequestQueue(RequestAcceptReject.this);
        JsonObjectRequest jsObjRequest2 = new JsonObjectRequest(Request.Method.GET, datalink, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    GlobalVariable.lattpat= Double.parseDouble(jsonObject.getString("latitude"));
                   GlobalVariable.longtpat= Double.parseDouble(jsonObject.getString("longitude"));
