...
String uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs2= getSharedPreferences("PreferenceDisplay", MODE_PRIVATE);
        prefs2.edit().remove("DataGet").commit();
GlobalVariable.lattpat=593;
        GlobalVariable.longtpat=693;
        GlobalVariable.uidpat="dadsdf";
